...
const HARDCODED_USDC_ADDRESS: `0x${string}` = '0x53E691B568B87f0124bb3A88C8b9958bF8396E81';

export function getUSDCAddress(chainId: number): `0x${string}` | undefined {
  return HARDCODED_USDC_ADDRESS;
}
...
export const USDC_ADDRESS = HARDCODED_USDC_ADDRESS;
