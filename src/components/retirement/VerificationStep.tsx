  ...
  const CheckItem: React.FC<{
    ...
    <div className={`rounded-xl p-5 border-2 transition-all ${
      ...
      <div className="flex items-start gap-4">
        <div className={`flex-shrink-0 mt-1 ${passed ? 'text-green-600' : 'text-red-600'}`}>
            ...
            <div className="space-y-2 text-sm">
              ...
              {!hasEnoughUSDC && (
                <div className="mt-3 bg-red-100 rounded-lg p-3">
                  <p className="text-red-800 font-semibold text-xs mb-2">
              ...
              {hasEnoughAllowance ? (
                ...
                <div className="space-y-2">
                  <p className="text-amber-800 font-semibold">
                    ⚠️ Necesitas aprobar el contrato
                  </p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <h4 className="font-bold text-green-800">
                  ✓ Todo listo para crear tu contrato
                </h4>
