...
const ContractCreatedPage: React.FC = () => {
  ...
  const handleApproveUSDC = async () => {
    ...
    try {
      ...
      const approvalGas = gasEstimate?.approvalGas || 100000n;
      ...
      console.log('⛽ Using approval gas limit:', approvalGas.toString());
    } catch (err: any) {
  ...
  const handleCreateFund = async () => {
    ...
    try {
      ...
      const createFundGas = gasEstimate?.createFundGas || 500000n;
      ...
      console.log('⛽ Using createFund gas limit:', createFundGas.toString());
      console.log('📊 Parameters:', {
        initialDeposit: planData.initialDeposit,
        yearsToRetirement: planData.retirementAge - planData.currentAge,
            ...
            <div className="p-8 sm:p-12 space-y-8">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-2xl p-6 border-2 border-emerald-200">
                  ...
                  <p className="text-sm text-gray-600 mt-2">97% returned to you for DeFi investment</p>
                </div>
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border-2 border-blue-200">
                  ...
                  <p className="text-sm text-gray-600 mt-2">Required to meet your retirement goal</p>
                </div>
              </div>
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3 bg-gray-50 rounded-xl p-4 border border-gray-200">
                  <code className="flex-1 text-sm font-mono text-gray-800 break-all">{txHash}</code>
                  <button
                ...
                {copied && <p className="text-green-600 font-semibold text-center animate-pulse">✅ Copied to clipboard</p>}
              </div>
              ...
              <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-8 border-2 border-indigo-200">
                ...
                <ul className="space-y-4 text-gray-700">
                  <li className="flex items-start gap-3 text-base sm:text-lg">
                    ...
                    <div><strong>Go to Dashboard</strong> to view your fund details and balance</div>
                  </li>
                  <li className="flex items-start gap-3 text-base sm:text-lg">
                    <span className="text-emerald-600 font-bold text-xl">✓</span>
                    <div><strong>Make monthly deposits</strong> of {formatCurrency(planData.monthlyDeposit || 0)} to stay on track</div>
                  </li>
                  <li className="flex items-start gap-3 text-base sm:text-lg">
                    <span className="text-emerald-600 font-bold text-xl">✓</span>
                    <div><strong>Monitor your progress</strong> and adjust your plan as needed</div>
                  </li>
                </ul>
              </div>
              <button
      ...
      <div className="max-w-4xl w-full">
        <div className="bg-white/95 backdrop-blur-2xl rounded-3xl shadow-2xl border-2 border-indigo-300 overflow-hidden">
          <div className="bg-gradient-to-r from-indigo-600 to-purple-700 p-8 sm:p-12 text-center text-white">
            ...
            <h1 className="text-3xl sm:text-5xl font-black mb-4">Confirm Your Retirement Fund</h1>
            <p className="text-base sm:text-xl opacity-90">Click confirm to execute the transactions</p>
          </div>
              ...
              <div className="bg-blue-50 border-2 border-blue-200 rounded-2xl p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    {(approvalHash || txHash) && (
                      <p className="text-xs text-blue-600 mt-2 font-mono break-all">TX: {approvalHash || txHash}</p>
                    )}
                  </div>
                </div>
          ...
          <div className="p-6 sm:p-12 space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-2xl p-6 border-2 border-emerald-200">
                ...
                <p className="text-4xl font-black text-emerald-700">{formatCurrency(planData.initialDeposit || 0)}</p>
              </div>
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border-2 border-blue-200">
                <div className="flex items-center gap-2 mb-2">
                  <Calendar className="text-blue-600" size={20} />
                ...
                <p className="text-4xl font-black text-blue-700">{formatCurrency(planData.monthlyDeposit || 0)}</p>
              </div>
            </div>
            ...
            {gasEstimate && (
              <div className="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-2xl p-6 border-2 border-amber-200">
                ...
                <p className="text-xs text-amber-800 mt-2">This covers both the approval and fund creation transactions</p>
              </div>
            )}
