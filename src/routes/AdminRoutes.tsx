...
export const ADMIN_PATHS = {
  ...
  ADMIN_GOVERNANCE: '/admin/admin_governance',
  TOKENS: '/admin/tokens',
...
export const adminRoutes: AdminRoute[] = [
  ...
  },
  {
    ...
    description: 'Manage DAO treasury and fees',
    requiresAuth: true,
    requiresAdmin: true,
    requiredRole: 'admin',
  },
  ...
  {
    path: ADMIN_PATHS.ADMIN_GOVERNANCE,
    component: GovernanceManagement,
...
export type AdminTab = 'admin_dashboard' | 'treasury' | 'contracts' | 'admin_governance' | 'tokens' | 'admin_contact';
...
export const getAdminTabFromPath = (path: string): AdminTab => {
  switch (path) {
    ...
    case ADMIN_PATHS.CONTRACTS:
      return 'contracts';
    case ADMIN_PATHS.ADMIN_GOVERNANCE:
